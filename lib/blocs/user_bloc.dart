...
class UserBloc extends BlocBase{
  ...
  void _addUsersListener(){
    //Sempre que tiver uma alteração na coleção users, um snapshot será recebido
      ...
      snapshot.documentChanges.forEach((change){
          ...
          switch(change.type){
            case DocumentChangeType.added:
              ...
              //Observar os pedidos do usuário
            ...
            case DocumentChangeType.removed:
              _users.remove(uid);
              //Parar de observar os pedidos do usuário
  ...
  void _subscribeToOrders(String uid){
    // Para obter os dados apenas uma vez
    //_firestore.collection("users").document(uid).collection("orders").getDocuments...
    //snapshots.listen é um listener do banco de dados e onera muita banda
